...
test <- read.csv("C:/Users/Msmeltzer/Desktop/FULL HRI DATA/Europe and Post Soviet/Plotly Maps for Aris/mapdata.csv")
...
g <- list(
  ...
  chart_link = api_create(p, filename = "GER_AllEqual_Change")
  ...
  chart_link = api_create(p, filename = "GER_Security_Change")
  ...
  chart_link = api_create(p, filename = "GER_Economic_Change")
  ...
  chart_link = api_create(p, filename = "GER_Diplomatic_Change")
  ...
  chart_link = api_create(p, filename = "GER_Informational_Change")